  ...
  return (
    <footer className="bg-foreground text-background py-12 px-4">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#how-to-buy" className="text-background/80 hover:text-background transition-colors">
                  How to Buy
                </a>
              </li>
              <li>
                <a href="/tokenomics" className="text-background/80 hover:text-background transition-colors">
                  Tokenomics
                </a>
              </li>
              <li>
                <a href="#roadmap" className="text-background/80 hover:text-background transition-colors">
                  Roadmap
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/whitepaper" className="text-background/80 hover:text-background transition-colors">
                  Whitepaper
                </a>
              </li>
              <li>
                <a href="https://www.freshcoins.io/audit/beaver-bux" className="text-background/80 hover:text-background transition-colors">
                  Audit Report
                </a>
              </li>
                <li>
                <a href="https://github.com/freshcoins/KYC/blob/main/BeaverBux_KYC.pdf" className="text-background/80 hover:text-background transition-colors">
                  KYC
                </a>
                </li>
              <li>
        ...
        {/* Disclaimer */}
        <div className="mt-8 text-xs text-background/70 text-center max-w-4xl mx-auto">
